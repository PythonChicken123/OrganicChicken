    ...
    */
    ...
    var Ic = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//,
        ...
        Lc = function(a) {
            ...
            null == b && (b = (a = (a || window.location.href).match(Jc)) ? a[1] : null);
            if (null == b) return null;
            b = String(b);
            21 < b.length && (b = null);
            return b
    ...
    qd.prototype.update = function(a, b) {
        if (null != a) {
            ...
            for (var c = b - this.blockSize, d = 0, e = this.L, f = this.v; d < b;) {
                if (0 == f)
                    for (; d <= c;) rd(this, a, d), d += this.blockSize;
                if ("string" === typeof a)
                    for (; d < b;) {
    ...
    var Qd = function(a) {
        ...
        Rd = function(a) {
            ...
            for (var b = document.getElementsByTagName("link"), c = 0, d = b.length; c < d; c++) {
                ...
                if (f && f.toLowerCase() == a && (e = e.getAttribute("href")) && (e = Qd(e)) && null != e.match(/^https?:\/\/[\w\-_\.]+/i)) return e
            }
                        ...
                        if (!q) {
                            if (!(q = k.rpctoken)) {
                                ...
                                if (ud) {
                                    ...
                                    y = Number("0." + y[0])
                                } else y = xd, y += parseInt(zd.substr(0, 20), 16), zd = Bd(zd), y /= yd + Math.pow(16, 20);
                                q = q(I.call(r, 1E8 * y))
                            }
                            u.rpctoken = q
                        }
    ...
    var He = "https:" === window.location.protocol,
        ...
        Ke = function() {
            ...
            Ie.iterate(function(c, d) {
                0 === c.indexOf("G_AUTHUSER_") && (c = Je(c.substring(11)), !a || c.l && !a.l || c.l == a.l && c.o > a.o) && (a = c, b = d)
            });
            return {
                fa: a,
                K: b
...
gapi.load("client", {
    callback: window["googleAuthInit"],
    _c: {
        "jsl": {
            "ci": {
                "deviceType": "desktop",
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en_US.J6wwVzZFlys.O/am\u003dAQ/d\u003d1/rs\u003dAGLTcCNJLWaj6_C-48nmIacOG08UNqZiFA/m\u003d__features__",
            "u": "https://apis.google.com/js/client:platform.js?onload\u003dgoogleAuthInit",
            "hee": true,
            "dpo": false,
            "le": ["oz"],
            "rol": false
